  ...
  useEffect(() => {
    ...
    return (
        <div id='Blog' className='relative'>
          <Image src={image2} alt='image' className='absolute top-0 left-0 h-full object-cover' />
            <div ref={wrapperRef} className='relative container mx-auto py-[50px] md:py-[68px] lg:py-[80px] xl:py-[110px] 2xl:py-[133px]'>
                <div className='flex items-center flex-col justify-center'>
                  ...
                  future Together!</h2>
                  <p className='bitstartp text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[20px] pt-[12px] sm:pt-[13px] md:pt-[14px] lg:pt-[15px] xl:pt-[16px] 2xl:pt-[20px] !text-center'>We help businesses and individuals leverage AI to drive growth, <br className='lg:block hidden'/>enhance efficiency, and foster innovation.</p>
